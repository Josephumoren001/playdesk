...
const ERROR_MESSAGES = {
  uploadError: 'Could not upload image (File must be less than 2MB)',
  noChanges: 'No changes made',
  imageUploading: 'Please wait for image to upload',
};
...
export default function DashProfile() {
  ...
  const uploadImage = async () => {
    ...
    uploadTask.on(
      ...
      (error) => {
        setImageFileUploadError(ERROR_MESSAGES.uploadError);
